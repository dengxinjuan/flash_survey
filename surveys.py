...
print(satisfaction_survey.title,satisfaction_survey.instructions,)
...
print(personality_quiz .title,personality_quiz.instructions,)
for q in personality_quiz.questions:
    print(q.question)
